...
namespace DNet.Core.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetJwtToken3(string name = "", string pass = "")
        {
            string jwtStr = string.Empty;
        ...
        [HttpGet]
        [Route("RefreshToken")]
        [ProducesResponseType(typeof(TokenInfoViewModel), StatusCodes.Status200OK)]
        public async Task<IActionResult> RefreshToken(string token = "")
        {
            ...
            {
                return BadRequest("token无效，请重新登录！");
            }
